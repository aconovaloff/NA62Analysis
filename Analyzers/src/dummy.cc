...
dummy::dummy(Core::BaseAnalysis *ba) : Analyzer(ba, "dummy")
{
	/// \MemberDescr
...
void dummy::ProcessSpecialTriggerUser(int iEvent, unsigned int triggerType){
	/// \MemberDescr
